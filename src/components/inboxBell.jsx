      ...
      >
        ...
        {unread > 0 && (
          <motion.span
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 text-white text-[9px] font-black flex items-center justify-center rounded-xl"
          >
            {unread > 9 ? '9+' : unread}
          </motion.span>
        )}
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50">
                <div className="flex items-center gap-3">
                  ...
                  {unread > 0 && (
                    <span className="px-2 py-0.5 bg-red-100 dark:bg-red-950/50 text-red-600 dark:text-red-400 text-[10px] font-black rounded-xl">
                      {unread} baru
                    </span>
                  )}
                </div>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between gap-3">
                                ...
                                {!ann.isRead && (
                                  <span className="w-2 h-2 bg-blue-500 rounded-xl flex-shrink-0 mt-1.5" />
                                )}
                              </div>
                              ...
                              <div className="flex items-center justify-between mt-1.5">
                                <span className={`text-[10px] font-black px-1.5 py-0.5 rounded-xl border ${cfg.bg} ${cfg.text} ${cfg.border}`}>
                                  {cfg.label}
                                </span>
  ...
  return (
    <div className="space-y-5 pb-8">
      ...
      {isLoading ? (
                  ...
                  <div className="flex-1 space-y-2.5">
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1.5 flex-1">
                        <div className="h-3.5 bg-slate-200 dark:bg-slate-700 rounded-xl" style={{ width: `${55 + i * 8}%` }} />
                        <div className="h-3 bg-slate-100 dark:bg-slate-800 rounded-xl w-full" />
                        <div className="h-3 bg-slate-100 dark:bg-slate-800 rounded-xl" style={{ width: '70%' }} />
                      </div>
                      <div className="h-5 w-10 bg-slate-100 dark:bg-slate-800 rounded-xl flex-shrink-0" />
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="h-4 w-16 bg-slate-100 dark:bg-slate-800 rounded-xl" />
                      <div className="h-3 w-20 bg-slate-100 dark:bg-slate-800 rounded-xl" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="py-20 text-center text-slate-400 bg-white/30 dark:bg-slate-900/60 backdrop-blur-sm border border-slate-100 dark:border-slate-800 rounded-xl">
          ...
          {filtered.map((ann, i) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-white/30 dark:bg-slate-900/60 backdrop-blur-sm border rounded-xl overflow-hidden shadow-sm transition-all ${
                  !ann.isRead
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 flex-wrap mb-1">
                            ...
                            {!ann.isRead && (
                              <span className="w-2 h-2 bg-blue-500 rounded-xl flex-shrink-0" />
                            )}
                          </div>
                        ...
                        {/* <div className="flex-shrink-0 flex items-center gap-3">
                          {ann.isRead ? (
                            ...
                            <span className="px-2 py-1 bg-blue-100 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 text-[9px] font-black rounded-xl border border-blue-200 dark:border-blue-900">
                              BARU
                            </span>
                          )}
                        </div> */}
                      ...
                      <div className="flex items-center gap-3 mt-2 flex-wrap">
                        <span className={`text-[10px] font-black px-2 py-0.5 rounded-xl border ${cfg.bg} ${cfg.text} ${cfg.border}`}>
                          {cfg.label}
                        </span>
