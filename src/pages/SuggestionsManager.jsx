...
export const SuggestionsManager = () => {
  ...
  return (
    <div className="md:space-y-5">
      ...
      {/* Form Kirim Saran */}
      <div className="bg-white dark:bg-slate-900 rouded-tl-lg rounded-tr-lg md:rounded-xl md:border border-slate-100 dark:border-slate-800 overflow-hidden">
        <button
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-blue-100 dark:bg-blue-950/40 rounded-xl flex items-center justify-center text-blue-600 dark:text-blue-400">
              <Send size={18} />
            </div>
          ...
          <div className={`w-8 h-8 flex items-center justify-center rounded-xl transition-all ${showForm ? 'rotate-180' : ''}`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 pt-5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {CATEGORIES.map((cat) => (
                    <button
                      ...
                      className={`cursor-pointer py-2.5 rounded-xl font-black text-xs transition-all border-2 ${
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={200}
                  className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 focus:border-blue-500 dark:focus:border-blue-500 outline-none font-bold text-sm text-slate-700 dark:text-slate-200 transition-all"
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={2000}
                  rows={4}
                  className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 focus:border-blue-500 dark:focus:border-blue-500 outline-none font-medium text-sm text-slate-700 dark:text-slate-200 transition-all resize-none"
                />
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 overflow-hidden">
        <div className="px-4 md:px-6 py-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
          ...
          <button onClick={() => refetch()} className="cursor-pointer p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-all">
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-16 text-slate-400 font-bold gap-3">
            <div className="w-5 h-5 border-4 border-slate-200 border-t-blue-600 rounded-xl animate-spin" />Memuat...
          </div>
