...
const FeeSimulator = ({ feeBearer }) => {
  ...
  // Streamer menerima (setelah potongan 3.5%)
    ...
    <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700 rounded-xl p-5 space-y-4">
      ...
      <div className="space-y-2 text-sm">
        ...
        <div className="flex justify-between text-red-300">
          <spa className='font-medium'>Biaya admin 3.5%</spa>
  ...
  const OPTIONS = [
    {
      ...
      subtitle: '3.5% dipotong dari saldo streamer',
      desc: 'Donor hanya membayar sesuai nominal yang diketik. Biaya 3.5% akan dipotong otomatis dari saldo kamu saat donasi masuk. Biaya tetap Rp4.000 dibebankan saat penarikan.',
      badge: 'Ramah Donor',
    ...
    },
    {
      ...
      subtitle: '3.5% ditambahkan ke nominal donasi',
      desc: 'Donor akan membayar nominal + 3.5%. Streamer menerima persis sesuai nominal yang diinput donor. Biaya tetap Rp4.000 tetap ditanggung streamer saat penarikan.',
      badge: 'Saldo Penuh',
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl p-4 md:p-5 shadow-sm border border-slate-100 dark:border-slate-800 space-y-5">
        ...
        <div className={`p-5 rounded-xl border ${feeBearer === 'streamer' 
          ...
          <p className="font-black text-sm mb-1">
            {feeBearer === 'streamer' 
              ? 'Mode Aktif: Streamer Menanggung 3.5%' 
              : 'Mode Aktif: Donor Menanggung 3.5%'}
          </p>
          <p className="text-[11px] text-slate-600 dark:text-slate-400">
            {feeBearer === 'streamer' 
              ? 'Donor bayar Rp100.000 → Streamer terima Rp96.500' 
              : 'Donor bayar Rp103.500 → Streamer terima Rp100.000'}
          </p>
