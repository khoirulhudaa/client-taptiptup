            ...
            {isDone ? (
              ...
              <div className="space-y-5">
                ...
                <input
                  ...
                  placeholder="000000"
                  className="w-full text-center text-4xl tracking-[14px] font-mono py-5 bg-slate-100 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 focus:border-blue-500 outline-none rounded-xl transition-all"
                  autoFocus
                />
