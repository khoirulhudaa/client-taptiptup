      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-6 font-sans">
        ...
        <div className="w-full max-w-md relative z-10">
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl overflow-hidden border border-blue-100 dark:border-slate-800"
          >
            {/* Top banner */}
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <motion.button
                  ...
                  whileTap={{ scale: 0.99 }}
                  onClick={handleShare}
                  className="cursor-pointer flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-blue-200 dark:border-blue-700 text-blue-600 dark:text-blue-400 font-bold text-sm hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-all"
                >
                  <Share2 size={16} />
                  Bagikan
                </motion.button>
                <motion.button
                  ...
                  whileTap={{ scale: 0.99 }}
                  onClick={handleBack}
                  className="cursor-pointer flex items-center justify-center gap-2 py-3 rounded-xl bg-blue-600 text-white font-bold text-sm hover:bg-blue-700 transition-all"
                >
                  <Home size={16} />
